...
try {
    ...
    echo "<p><a href='login.php' style='color: #2563eb; text-decoration: none; font-weight: bold;'>Go to Login Page</a></p>";
    echo "<p><a href='register.php' style='color: #2563eb; text-decoration: none; font-weight: bold;'>Go to Register Page</a></p>";
