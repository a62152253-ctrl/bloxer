...
<body>
    <div class="auth-container setup-container">
        ...
        <form method="POST" action="">
            ...
            <a href="../controllers/auth/login.php" class="btn" style="background: var(--input-bg); text-decoration: none; display: inline-block;">Cancel</a>
        </form>

        <div class="links">
            <a href="../controllers/auth/login.php">← Back to Login</a>
        </div>
    </div>
</body>
</html>
