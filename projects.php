...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['action'] === 'create_project') {
    ...
    if (!empty($name)) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: editor.php?project_id=' . $new_project_id);
            exit();
        }
    }
}
...
<body>
                ...
                <?php foreach ($projects as $project): ?>
                    <div class="project-card">
                        ...
                        <div class="project-actions">
                            <a href="editor.php?project_id=<?php echo $project['id']; ?>" class="btn btn-primary">
                                <i class="fas fa-code"></i>
                                Open
                            </a>
    ...
    <script src="project-wizard.js"></script>
</body>
</html>
